...
import {table, id, index, fk, field} from '..';
  ...
  it('two field decorators', async (done) => {
    try {
      ...
      class Model {
        ...
        @field({name: 'MDM2:COL'}) @field({name: 'MDM2:COL2'})
        col?: number;
      }
      fail('should have thrown');
    } catch (err) {
  ...
  it('two index decorators', async (done) => {
    try {
      ...
      class Model {
        ...
        @field({name: 'MDM3:COL'}) @index('MPT3:IDX1') @index('MPT3:IDX1')
        col?: number;
      }
      fail('should have thrown');
    } catch (err) {
  ...
  it('conflicting foreign key decorators', async (done) => {
    try {
      ...
      class Model {
        ...
        @field({name: 'MDM4:COL'}) @fk('MDM4:FK1', 'MDM4:T1', 'MDM4:ID') @fk('MDM4:FK1', 'MDM4:T1', 'MDM4:ID')
        col?: number;
      }
      fail('should have thrown');
    } catch (err) {
